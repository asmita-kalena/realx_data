  ...
  describe "#receive" do
    ...
    context "given input L" do
      it "turns the rover left" do
        @rover.should_receive :left_turn
        @operator.receive "L"
      end
    end
    ...
    context "given input R" do
      it "turns the rover right" do
        @rover.should_receive :right_turn
        @operator.receive "R"
      end
    end
    ...
    context "given input diferent of L, R or M" do
      it "ignores the input and let the rover still" do
        ...
        @rover.should_not_receive :left_turn
        @rover.should_not_receive :right_turn
    ...
    context "given input LL" do
      it "turns the rover left twice" do
        @rover.should_receive(:left_turn).twice
        @operator.receive "LL"
      end
    end
